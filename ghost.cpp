...
int wallCollide(int x, int y, int dir, int level[12][12]) {
...
void ghost::chase1(int x, int y, int level[12][12]) {
...
void ghost::chase2(int x, int y, int level[12][12]) {
	...
	// Once we've decided where to move, do so.
	if (direction == UP) ypos -= 6;
	else if (direction == DOWN) ypos += 6;
	else if (direction == LEFT) xpos -= 6;
	else if (direction == RIGHT) xpos += 6;


}
void ghost::chase3(int x, int y, int level[12][12]) {
	//this is just for testing, used this to get it to work :)
	cout << "state is " << direction << endl;
	if (wallCollide(xpos, ypos, LEFT, level));
	//	cout << "there's a wall to the left of me" << endl;
...
void ghost::chase4(int x, int y, int level[12][12]) {
	//this is just for testing, used this to get it to work :)
	cout << "state is " << direction << endl;
	if (wallCollide(xpos, ypos, LEFT, level));
	//	cout << "there's a wall to the left of me" << endl;
